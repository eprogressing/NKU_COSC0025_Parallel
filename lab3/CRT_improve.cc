...
// Three moduli and their primitive root
...
static const int64 mod3 = 469762049;  // 469,762,049 = 7·2^26+1, primitive root 3
static const int64 G = 3;

// Precomputed inverses for CRT
...
// Polynomial multiplication with three moduli and CRT
